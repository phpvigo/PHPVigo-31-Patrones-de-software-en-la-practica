...
class Task
{
     ...
     * @param $user
     */
    public function __construct($text, $due, AbstractUser $user, AbstractPriority $priority)
    {
        $this->text = $text;
        $this->due = $due;
        $this->user = $user;
...
abstract class AbstractPriority
{
	abstract public function __toString();
}

class PriorityHigh extends AbstractPriority
{
...
class PriorityMedium  extends AbstractPriority
{
	public function __toString()
	{
		return "Medium";
...
class PriorityLow extends AbstractPriority
{
	public function __toString()
	{
		return "Low";
...
class NullPriority extends AbstractPriority
{
	public function __toString()
	{
		return "--No Priority--";
...
{
    abstract public function isValidForNotification();
    abstract public function __toString();
}
...
class Notification
{
     ...
     * @param $read
     */
    public function __construct(AbstractUser $user, string $text)
    {
        $this->user = $user;
        $this->text = $text;
        $this->read = false;
