...
class Task
{
     ...
     * @param $user
     */
    public function __construct($text, $due, NullUser $user, NullPriority $priority)
    {
        $this->text = $text;
        $this->due = $due;
        $this->user = $user;
...
class PriorityHigh extends NullPriority
{
	public function __toString()
	{
		return "High";
...
class PriorityMedium  extends NullPriority
{
	public function __toString()
	{
		return "Medium";
...
class PriorityLow extends NullPriority
{
	public function __toString()
	{
		return "Low";
